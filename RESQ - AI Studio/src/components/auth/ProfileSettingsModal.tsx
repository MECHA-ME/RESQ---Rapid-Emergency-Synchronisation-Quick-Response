...
export default function ProfileSettingsModal({
  ...
  const getRoleDisplay = (r: UserRole) => {
    switch (r) {
      ...
      case 'FIRE_RESCUE':
        return {
          name: 'Fire & Rescue Personnel',
          agency: 'Station 9 Heavy Response',
  ...
  const name = userProfile?.fullName || (
    ...
    role === 'FIRE_RESCUE' ? 'Capt. Michael Vance' :
  ...
  return (
    <div className="absolute inset-0 bg-black/60 backdrop-blur-xs z-50 flex flex-col justify-end p-2 sm:p-3 animate-fade-in">
