        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider ${
              incident.type === 'AMBULANCE' ? 'bg-blue-500/30 text-blue-200 border border-blue-400/30' : 'bg-amber-500/30 text-amber-200 border border-amber-400/30'
            }`}>
              {incident.type === 'AMBULANCE' ? '🚑 Ambulance Emergency' : '🚒 Fire & Rescue'}
            </span>
          </div>
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="border border-slate-200 rounded-2xl divide-y divide-slate-100 overflow-hidden text-xs">
            ...
            {/* Node 2: Unit Acceptance (Ambulance / Fire Rescue) */}
            <div className="p-3 bg-white flex items-start gap-3 hover:bg-slate-50/50">
