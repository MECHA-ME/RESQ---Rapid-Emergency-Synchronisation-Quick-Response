...
export default function QaresFlowchartPipeline({ 
  ...
  const stages = [
    ...
    { id: isEscalatedBranch ? 'CALL_108' : 'UNIT_ACCEPTED', label: isEscalatedBranch ? 'Calling Agent 108 EMS' : 'Unit Accepted' },
          ...
          <div className="space-y-3">
              ...
              <div className="p-3 rounded-xl bg-white/5 border border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-[9px] text-gray-400">Ambulance (ALS/BLS)</div>
                  </div>
                </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-800/80 border-2 border-dashed border-slate-600 space-y-2.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                {/* Branch NO: Automatic Calling Agent (108) */}
                <div className={`p-3 rounded-lg border transition-all ${
                  isEscalatedBranch
